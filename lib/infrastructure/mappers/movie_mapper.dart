...
class MovieMapper {
  ...
  static Movie movieDbToEntity(MovieMovieDB moviedb) => Movie(
      adult: moviedb.adult, // Mapea la propiedad adult de moviedb a la propiedad adult de Movie.
      backdropPath: (moviedb.backdropPath != '') // Comprueba si backdropPath no está vacío.
      ...
      genreIds: moviedb.genreIds.map((e) => e.toString()).toList(), // Mapea genreIds convirtiendo cada elemento a una cadena y creando una lista de cadenas.
      id: moviedb.id, // Mapea id de moviedb a id de Movie.
      originalLanguage: moviedb.originalLanguage, // Mapea originalLanguage de moviedb a originalLanguage de Movie.
      originalTitle: moviedb.originalTitle, // Mapea originalTitle de moviedb a originalTitle de Movie.
      overview: moviedb.overview, // Mapea overview de moviedb a overview de Movie.
      popularity: moviedb.popularity, // Mapea popularity de moviedb a popularity de Movie.
      posterPath: (moviedb.posterPath != '') // Comprueba si posterPath no está vacío.
      ...
      releaseDate: moviedb.releaseDate, // Mapea releaseDate de moviedb a releaseDate de Movie.
      title: moviedb.title, // Mapea title de moviedb a title de Movie.
      video: moviedb.video, // Mapea video de moviedb a video de Movie.
      voteAverage: moviedb.voteAverage, // Mapea voteAverage de moviedb a voteAverage de Movie.
      voteCount: moviedb.voteCount); // Mapea voteCount de moviedb a voteCount de Movie.
}
